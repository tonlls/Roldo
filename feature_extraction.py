...
basepath_train_cough = 'D:/GitHub/Roldo/Cough_dataset/Unlabeled audio/TRAIN/Cough/'
basepath_train_nocough = 'D:/GitHub/Roldo/Cough_dataset/Unlabeled audio/TRAIN/No_Cough/'
...
df.to_excel('D:/GitHub/Roldo/Cough_dataset/Unlabeled audio/TRAIN/features_extracted.xlsx', index=False, header=True)

df = pd.read_excel('D:/GitHub/Roldo/Cough_dataset/Unlabeled audio/TRAIN/features_extracted.xlsx')
print(df)
...
basepath = 'D:/GitHub/Roldo/Cough_dataset/Labeled audio/Positives_audios/'
...
metadata = pd.read_excel('D:/GitHub/Roldo/Cough_dataset/Labeled audio/metadata.xlsx')
